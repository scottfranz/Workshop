...
export default function WritingPage() {
  ...
  if (view === "read" && selected) return (
    <div style={{ display:"flex", flexDirection:"column", height:"100vh" }}>
      <style>{`
        .read-body-area:hover .read-edit-hint { opacity: 1; }
      `}</style>
      ...
      <div style={{ flex:1, overflowY:"auto", padding:"36px 48px" }}>
        <div style={{ maxWidth:680 }}>
          ...
          {/* Clickable content area — click anywhere in title/body to open editor */}
          <div
            className="read-body-area"
            onClick={() => { console.log("CLICKED", selected); openEditor(selected); }}
